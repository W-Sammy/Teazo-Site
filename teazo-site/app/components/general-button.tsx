...
export default function GeneralButton({ text, href }: Editables) {
    return (
        ...
        >
            <button className={`${montserrat.className} w-[213px] h-[70px] bg-black text-white text-[18px] flex items-center justify-center hover:bg-[#FFBDC7] transition-colors tracking-[0.05em]`}>
                {text}
            </button>
        </Link>
    );
